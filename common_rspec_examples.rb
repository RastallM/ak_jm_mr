RSpec.describe 'Common, built-in expectation matchers' do
  example 'Equality' do
    ...
    # see this nice overview of == vs eql? vs equal? if you want to understand the difference https://medium.com/@khalidh64/difference-between-eql-equal-in-ruby-2ffa7f073532
  end
